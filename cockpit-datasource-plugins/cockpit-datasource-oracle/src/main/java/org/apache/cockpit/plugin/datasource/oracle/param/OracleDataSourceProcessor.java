...
import org.apache.cockpit.plugin.datasource.oracle.catalog.*;
...
public class OracleDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    private final OracleQueryBuilder queryBuilder;

    public OracleDataSourceProcessor() {
    ...
    public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) {
        return OracleParamConverter.createParamDTOFromConnection(connectionJson);
    }

    @Override
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        return OracleParamConverter.createConnectionParamFromDTO(dataSourceParam);
    }
    ...
    public List<String> splitAndRemoveComment(String sql) {
        return OracleQueryParser.splitAndRemoveComment(sql);
    }
    ...
    public List<String> listTables(ConnectionParam connectionParam) {
        return OracleMetadataService.listTables(connectionParam, this);
    }

    @Override
    public List<DataSourceTableColumn> listColumns(ConnectionParam connectionParam, String tableName) {
        return OracleMetadataService.listColumns(connectionParam, tableName, this);
    }

    @Override
    public QueryResult getTop20Data(ConnectionParam connectionParam, Map<String, Object> requestBody) {
        return OracleMetadataService.getTop10Data(connectionParam, requestBody, this);
    }
}