...
import org.apache.cockpit.plugin.datasource.postgresql.catalog.*;
...
public class PostgreSQLDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    public PostgreSQLDataSourceProcessor() {
    ...
    public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) {
        return PostgreSQLParamConverter.createParamDTOFromConnection(connectionJson);
    }

    @Override
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        return PostgreSQLParamConverter.createConnectionParamFromDTO(dataSourceParam);
    }
    ...
    public List<String> splitAndRemoveComment(String sql) {
        return PostgreSQLQueryParser.splitAndRemoveComment(sql);
    }
    ...
    public List<String> listTables(ConnectionParam connectionParam) {
        return PostgreSQLMetadataService.listTables(connectionParam, this);
    }

    @Override
    public List<DataSourceTableColumn> listColumns(ConnectionParam connectionParam, String tableName) {
        return PostgreSQLMetadataService.listColumns(connectionParam, tableName, this);
    }

    @Override
    public QueryResult getTop20Data(ConnectionParam connectionParam, Map<String, Object> requestBody) {
        return PostgreSQLMetadataService.getTop10Data(connectionParam, requestBody, this);
    }
}