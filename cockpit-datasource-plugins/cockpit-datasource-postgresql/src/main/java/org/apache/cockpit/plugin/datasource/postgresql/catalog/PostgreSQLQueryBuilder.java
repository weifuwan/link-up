...
public class PostgreSQLQueryBuilder {
    ...
    public JSONObject buildSourceJson(String connectionParam, String sourceParam) {
        ...
        PostgreSQLConnectionParam connectionParams = (PostgreSQLConnectionParam) JSONUtils.parseObject(connectionParam, PostgreSQLConnectionParam.class);
    ...
    public JSONObject buildSinkJson(String connectionParams, String globalParam) {
        ...
        PostgreSQLConnectionParam connectionParam = (PostgreSQLConnectionParam) JSONUtils.parseObject(connectionParams, PostgreSQLConnectionParam.class);
        JSONObject jsonObject = new JSONObject();
