...
import org.apache.cockpit.plugin.datasource.doris.catalog.*;
...
public class DorisDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    public DorisDataSourceProcessor() {
        this.connectionManager = new DorisConnectionManager();
        this.queryBuilder = new DorisQueryBuilder();
    }
    ...
    public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) throws NumberFormatException {
        return DorisParamConverter.createParamDTOFromConnection(connectionJson);
    }

    @Override
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        return DorisParamConverter.createConnectionParamFromDTO(dataSourceParam);
    }
    ...
    public List<String> splitAndRemoveComment(String sql) {
        return DorisQueryParser.splitAndRemoveComment(sql);
    }
    ...
    public List<String> listTables(ConnectionParam connectionParam) {
        return DorisMetadataService.listTables(connectionParam, this);
    }

    @Override
    public List<DataSourceTableColumn> listColumns(ConnectionParam connectionParam, String tableName) {
        return DorisMetadataService.listColumns(connectionParam, tableName, this);
    }

    @Override
    public QueryResult getTop20Data(ConnectionParam connectionParam, Map<String, Object> requestBody) {
        return DorisMetadataService.getTop20Data(connectionParam, requestBody, this);
    }
}