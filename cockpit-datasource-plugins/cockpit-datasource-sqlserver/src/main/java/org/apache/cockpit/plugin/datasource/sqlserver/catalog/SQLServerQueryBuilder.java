...
public class SQLServerQueryBuilder {
    ...
    public JSONObject buildSourceJson(String connectionParam, String sourceParam) {
        ...
        SQLServerConnectionParam connectionParams = JSONUtils.parseObject(connectionParam, SQLServerConnectionParam.class);
        ...
        if (org.apache.commons.lang.StringUtils.isNotBlank(sourceParamObj.getString("query"))) {
            jsonObject.put("query", sourceParamObj.getString("query"));
        }

        jsonObject.put("plugin-type", DbType.SQLSERVER.getCode());
        jsonObject.put("dialect", DbType.SQLSERVER.getCode());
    ...
    public JSONObject buildSinkJson(String connectionParams, String globalParam) {
        ...
        SQLServerConnectionParam connectionParam = (SQLServerConnectionParam) JSONUtils.parseObject(connectionParams, SQLServerConnectionParam.class);
        ...
        if (sinkObj.getBoolean("autoCreateTable")) {
            ...
            if (split.length == 1) {
                ...
                sinkTablePath = connectionParam.getSchema() + "." + sinkTablePath;
            }
    ...
    private String buildWhereCondition(JSONArray filterConditions) {
        ...
        for (int i = 0; i < filterConditions.size(); i++) {
            ...
            if (i > 0 && org.apache.commons.lang.StringUtils.isBlank(logicalOperator)) {
