...
import org.apache.cockpit.plugin.datasource.sqlserver.catalog.*;
...
public class SQLServerDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    private final SQLServerConnectionManager connectionManager;
    private final SQLServerQueryBuilder queryBuilder;

    public SQLServerDataSourceProcessor() {
        this.connectionManager = new SQLServerConnectionManager();
        this.queryBuilder = new SQLServerQueryBuilder();
    }
    ...
    public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) {
        return SQLServerParamConverter.createParamDTOFromConnection(connectionJson);
    }

    @Override
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        return SQLServerParamConverter.createConnectionParamFromDTO(dataSourceParam);
    }
    ...
    public QueryResult getTop20Data(ConnectionParam connectionParam, Map<String, Object> requestBody) {
        return SQLServerMetadataService.getTop20Data(connectionParam, requestBody, this);
    }
    ...
    public List<String> splitAndRemoveComment(String sql) {
        return SQLServerQueryParser.splitAndRemoveComment(sql);
    }
    ...
    public List<String> listTables(ConnectionParam connectionParam) {
        return SQLServerMetadataService.listTables(connectionParam, this);
    }

    @Override
    public List<DataSourceTableColumn> listColumns(ConnectionParam connectionParam, String tableName) {
        return SQLServerMetadataService.listColumns(connectionParam, tableName, this);
    }
}