...
public class StarRocksSinkOptions extends StarRocksBaseOptions {
    ...
    public static final Option<SinkConfig.StreamLoadFormat> LOAD_FORMAT =
            Options.key("starrocks.config.format")
                    .enumType(SinkConfig.StreamLoadFormat.class)
                    .defaultValue(SinkConfig.StreamLoadFormat.JSON)
                    .withDescription("");
