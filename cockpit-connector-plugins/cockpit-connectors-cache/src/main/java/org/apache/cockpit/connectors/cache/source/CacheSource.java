...
public class CacheSource
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(CacheSource.class);

    private final JdbcSourceConfig jdbcSourceConfig;
    private final Map<TablePath, JdbcSourceTable> jdbcSourceTables;

    @SneakyThrows
    public CacheSource(JdbcSourceConfig jdbcSourceConfig) {
    ...
    public SourceReader<SeaTunnelRow, JdbcSourceSplit> createReader(
        ...
        return new CacheSourceReader(readerContext, jdbcSourceConfig, tables, jdbcSourceTables);
    }
