...
public class OpenGaussSourceFactory implements TableSourceFactory {
    @Override
    ...
    TableSource<T, SplitT> createSource(TableSourceFactoryContext context) {
        ...
        return () -> (SeaTunnelSource<T, SplitT>) new OpenGaussSource(config);
    }
