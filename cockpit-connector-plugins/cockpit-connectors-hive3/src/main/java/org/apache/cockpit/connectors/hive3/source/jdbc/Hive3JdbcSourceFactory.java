...
public class Hive3JdbcSourceFactory implements TableSourceFactory {
    @Override
    ...
    TableSource<T, SplitT> createSource(TableSourceFactoryContext context) {
        ...
        return () -> (SeaTunnelSource<T, SplitT>) new Hive3JdbcSource(config);
    }
