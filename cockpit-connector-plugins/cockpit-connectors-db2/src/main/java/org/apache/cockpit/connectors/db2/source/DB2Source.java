package org.apache.cockpit.connectors.db2.source;
...
public class DB2Source
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(DB2Source.class);

    private final JdbcSourceConfig jdbcSourceConfig;
    private final Map<TablePath, JdbcSourceTable> jdbcSourceTables;

    @SneakyThrows
    public DB2Source(JdbcSourceConfig jdbcSourceConfig) {
    ...
    public SourceReader<SeaTunnelRow, JdbcSourceSplit> createReader(
        ...
        return new DB2SourceReader(readerContext, jdbcSourceConfig, tables, jdbcSourceTables);
    }
