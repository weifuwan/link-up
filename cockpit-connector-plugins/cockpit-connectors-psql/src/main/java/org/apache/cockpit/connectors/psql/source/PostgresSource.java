package org.apache.cockpit.connectors.psql.source;
...
public class PostgresSource
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(PostgresSource.class);

    private final JdbcSourceConfig jdbcSourceConfig;
    private final Map<TablePath, JdbcSourceTable> jdbcSourceTables;

    @SneakyThrows
    public PostgresSource(JdbcSourceConfig jdbcSourceConfig) {
    ...
    public SourceReader<SeaTunnelRow, JdbcSourceSplit> createReader(
        ...
        return new PostgresSourceReader(readerContext, jdbcSourceConfig, tables, jdbcSourceTables);
    }
