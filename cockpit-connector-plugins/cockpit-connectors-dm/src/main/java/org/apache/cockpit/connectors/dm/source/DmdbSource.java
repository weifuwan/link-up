package org.apache.cockpit.connectors.dm.source;
...
public class DmdbSource
    ...
    public SourceReader<SeaTunnelRow, JdbcSourceSplit> createReader(
        ...
        return new DmdbSourceReader(readerContext, jdbcSourceConfig, tables, jdbcSourceTables);
    }
