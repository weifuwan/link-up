...
import org.apache.cockpit.connectors.doris.sink.HttpPutBuilder;
import org.apache.cockpit.connectors.doris.sink.LoadStatus;
import org.apache.cockpit.connectors.doris.util.ResponseUtil;
...
import static org.apache.cockpit.connectors.doris.sink.writer.LoadConstants.LINE_DELIMITER_DEFAULT;
import static org.apache.cockpit.connectors.doris.sink.writer.LoadConstants.LINE_DELIMITER_KEY;
import static org.apache.cockpit.connectors.doris.util.ResponseUtil.LABEL_EXIST_PATTERN;
...
public class DorisStreamLoad implements Serializable {
    ...
    private RespContent handlePreCommitResponse(CloseableHttpResponse response) throws Exception {
        ...
        if (statusCode == HTTP_TEMPORARY_REDIRECT && response.getEntity() != null) {
            ...
            log.debug("load Result {}", loadResult);
