...
import org.apache.cockpit.connectors.doris.datatype.DorisTypeConverterFactory;
import org.apache.cockpit.connectors.doris.datatype.DorisTypeConverterV2;
import org.apache.cockpit.connectors.doris.util.DorisCatalogUtil;
...
public class DorisCatalog implements Catalog {
    ...
    private Column buildColumn(ResultSet resultSet) throws SQLException {
        ...
        checkArgument(!(numberPrecision > 0 && charOctetLength > 0));
        checkArgument(!(numberScale > 0 && timePrecision > 0));
