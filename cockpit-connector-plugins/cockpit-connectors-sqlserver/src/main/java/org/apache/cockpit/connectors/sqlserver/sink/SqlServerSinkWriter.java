package org.apache.cockpit.connectors.sqlserver.sink;
...
@Slf4j
public class SqlServerSinkWriter extends AbstractJdbcSinkWriter<ConnectionPoolManager> {
    private final Integer primaryKeyIndex;

    public SqlServerSinkWriter(
