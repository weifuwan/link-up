...
public class SqlServerSourceFactory implements TableSourceFactory {
    @Override
    ...
    TableSource<T, SplitT> createSource(TableSourceFactoryContext context) {
        ...
        return () -> (SeaTunnelSource<T, SplitT>) new SqlServerSource(config);
    }
