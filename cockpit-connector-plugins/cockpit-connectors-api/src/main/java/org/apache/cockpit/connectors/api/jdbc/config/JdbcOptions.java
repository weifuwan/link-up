...
public interface JdbcOptions {
    ...
    Option<String> JDBC_URL = Options.key("jdbcUrl").stringType().noDefaultValue().withDescription("url");
    ...
    Option<String> USERNAME = Options.key("username").stringType().noDefaultValue().withDescription("username");
