package org.apache.cockpit.connectors.mysql.source;
...
public class MysqlSource
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(MysqlSource.class);

    private final JdbcSourceConfig jdbcSourceConfig;
    private final Map<TablePath, JdbcSourceTable> jdbcSourceTables;

    @SneakyThrows
    public MysqlSource(JdbcSourceConfig jdbcSourceConfig) {
    ...
    public SourceReader<SeaTunnelRow, JdbcSourceSplit> createReader(
        ...
        return new MysqlSourceReader(readerContext, jdbcSourceConfig, tables, jdbcSourceTables);
    }
