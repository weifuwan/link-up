...
public class OracleSource
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(OracleSource.class);

    private final JdbcSourceConfig jdbcSourceConfig;
    private final Map<TablePath, JdbcSourceTable> jdbcSourceTables;

    @SneakyThrows
    public OracleSource(JdbcSourceConfig jdbcSourceConfig) {
    ...
    public SourceReader<SeaTunnelRow, JdbcSourceSplit> createReader(
        ...
        return new OracleSourceReader(readerContext, jdbcSourceConfig, tables, jdbcSourceTables);
    }
