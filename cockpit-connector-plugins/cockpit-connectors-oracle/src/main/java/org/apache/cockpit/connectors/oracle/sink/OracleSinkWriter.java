package org.apache.cockpit.connectors.oracle.sink;
...
@Slf4j
public class OracleSinkWriter extends AbstractJdbcSinkWriter<ConnectionPoolManager> {
    private final Integer primaryKeyIndex;

    public OracleSinkWriter(
