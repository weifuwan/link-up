      ...
      >
        ...
        <div style={{ width: '100%', display: 'flex' }}>
          ...
          >
            ...
            <p style={{ color: '#1e202d', fontSize: 12, textAlign: 'center' }}>Step1</p>
            <p style={{ color: 'rgba(185,185,185,1)', fontSize: 12, textAlign: 'center' }}>
              选择来源数据源
            </p>
          </div>
          ...
          >
            <RightOutlined
              style={{ fontWeight: 500, fontSize: 11, color: 'rgba(185,185,185,1)' }}
            />
          </div>
          ...
          >
            ...
            <p style={{ color: '#1e202d', fontSize: 12, textAlign: 'center' }}>Step2</p>
            <p style={{ color: 'rgba(185,185,185,1)', fontSize: 12, textAlign: 'center' }}>
              选择去向数据源
            </p>
          </div>
          ...
          >
            ...
            <p style={{ color: '#1e202d', fontSize: 12, textAlign: 'center' }}>Step3</p>
            <p style={{ color: 'rgba(185,185,185,1)', fontSize: 12, textAlign: 'center' }}>
              配置同步任务
            </p>
          </div>
          ...
          >
            ...
            <p style={{ color: '#1e202d', fontSize: 12, textAlign: 'center' }}>Step4</p>
            <p style={{ color: 'rgba(185,185,185,1)', fontSize: 12, textAlign: 'center' }}>
              运行任务
            </p>
          </div>
