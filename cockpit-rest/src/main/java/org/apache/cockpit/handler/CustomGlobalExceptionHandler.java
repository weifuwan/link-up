package org.apache.cockpit.handler;

import org.apache.cockpit.common.bean.entity.result.Result;
import org.apache.cockpit.common.bean.entity.result.ResultStatus;
...
public class CustomGlobalExceptionHandler {
    ...
    public Result<Void> methodArgumentNotValidException(MethodArgumentNotValidException me) {
        ...
        List<String> errorList = fieldErrorList.stream().map(DefaultMessageSourceResolvable::getDefaultMessage).collect(Collectors.toList());
