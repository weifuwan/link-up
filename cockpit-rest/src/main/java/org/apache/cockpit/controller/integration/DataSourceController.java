...
public class DataSourceController {
    ...
    public Result<String> update(@PathVariable String id, @RequestBody DataSourceDTO dto) {
    ...
    public Result<List<OptionVO>> option(@RequestParam("dbType") String dbType) {
    ...
    public Result<Boolean> connectionTest(@PathVariable("id") String id) {
    ...
    public Result<Boolean> batchConnectionTest(@RequestBody List<String> ids) {
